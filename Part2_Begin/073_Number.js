...
const test = Number.parseInt(order3.price) + Number.parseInt(order4.price);

// print
console.log('order1.price + order2.price : %s', concatenate);
console.log('parseInt(order1.price, 10) + parseInt(order2.price, 10) : %s', sum1);
console.log('parseInt(order3.price, 10) + parseInt(order4.price, 10) : %s', sumParseInt);
console.log('Number(order3.price) + Number(order4.price) : %s', sumNumber);
console.log('Number.parseInt(order3.price) + Number.parseInt(order4.price) : %s', test);
